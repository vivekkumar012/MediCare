...
//normalize schedule map: ex- 'YYYY-MM-DD' : [slot1, slot2, slot3.....]
...
const ListPage = () => {
  ...
  //show doctors according to filters
    ...
    <div className={doctorListStyles.container}>
      ...
      <main className={doctorListStyles.gridContainer}>
        ...
        {displayed.map((doc) => {
          ...
          const storedDates = getSortedScheduleDates(scheduleMap);
