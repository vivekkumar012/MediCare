    ...
    <div className={testimonialStyles.container}>
      <div className={testimonialStyles.headerContainer}>
        ...
        <p className={testimonialStyles.subtitle}>
          Real stories from doctors and patients their positive experiences with
          out healthcare platforms.
        </p>
      </div>
      ...
      >
        ...
        >
          <div
            className={`${testimonialStyles.columnHeader} ${testimonialStyles.rightColumnBorder}`}
          >
            🧑‍💼 Patients
          </div>
